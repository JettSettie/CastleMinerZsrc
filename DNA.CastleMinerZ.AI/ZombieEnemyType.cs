namespace DNA.CastleMinerZ.AI
{
	...
	{
		public ZombieEnemyType(EnemyTypeEnum t, ModelNameEnum model, TextureNameEnum tname, FoundInEnum foundin, int maxDigHardness, float digMultiplier)
			: base(t, model, tname, foundin, SessionStats.StatType.ZombieDefeated)
		{
			...
			DiggingMultiplier = digMultiplier;
			HardestBlockThatCanBeDug = maxDigHardness;
		}
