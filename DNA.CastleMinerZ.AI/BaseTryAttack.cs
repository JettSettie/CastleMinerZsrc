...
namespace DNA.CastleMinerZ.AI
{
	...
	{
		protected abstract string[] AttackArray
		{
			get;
		}

		protected abstract string RageAnimation
		{
			get;
		}

		protected abstract float[][] HitTimes
		{
			get;
		}

		protected abstract float[] HitDamages
		{
			get;
		}

		protected abstract float[] HitRanges
		{
			get;
		}

		protected abstract float HitDotMultiplier
		{
			get;
		}
