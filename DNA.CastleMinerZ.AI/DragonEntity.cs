...
namespace DNA.CastleMinerZ.AI
{
	public class DragonEntity : Entity
	{
		...
		public static readonly string[] AnimNames = new string[4]
		{
			"flying_idle",
			"fly_forward",
			"gethit",
		...
		public void InitSpawnState()
		{
			...
			Vector3 value = DragonBaseState.MakeYawVector(num);
			worldPosition -= value * EType.SpawnDistance;
		...
		public override void Update(DNAGame game, GameTime gameTime)
		{
			...
			UpdateSounds(gameTime.ElapsedGameTime);
