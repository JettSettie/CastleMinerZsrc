...
namespace DNA.CastleMinerZ.UI
{
	public class WaitScreen : Screen
	{
		...
		protected override void OnDraw(GraphicsDevice device, SpriteBatch spriteBatch, GameTime gameTime)
		{
			...
			Vector2 location = new Vector2((float)(Screen.Adjuster.ScreenRect.Width / 2) - vector.X / 2f, (float)(Screen.Adjuster.ScreenRect.Height / 2) + vector.Y / 2f);
			textFlashTimer.Update(gameTime.ElapsedGameTime);
			Color textColor = Color.Lerp(CMZColors.MenuGreen, Color.White, textFlashTimer.PercentComplete);
