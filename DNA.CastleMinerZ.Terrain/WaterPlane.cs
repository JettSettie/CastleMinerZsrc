...
namespace DNA.CastleMinerZ.Terrain
{
	public class WaterPlane : Entity
	{
		...
		public WaterPlane(GraphicsDevice gd, ContentManager cm)
		{
			...
			_reflectionTexture = new RenderTarget2D(CastleMinerZGame.Instance.GraphicsDevice, Screen.Adjuster.ScreenRect.Width, Screen.Adjuster.ScreenRect.Height, true, SurfaceFormat.Color, DepthFormat.Depth16);
			_effect = cm.Load<Effect>("Shaders\\WaterEffect");
