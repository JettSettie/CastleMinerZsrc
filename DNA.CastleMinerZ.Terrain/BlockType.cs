...
namespace DNA.CastleMinerZ.Terrain
{
	public class BlockType
	{
		...
		static BlockType()
		{
			...
			_blockTypes[61].AllowSlopes = false;
			_blockTypes[60].AllowSlopes = false;
			_blockTypes[62].AllowSlopes = false;
			_blockTypes[63].AllowSlopes = false;
		}
		...
		{
			if (blockType == BlockTypeEnum.Crate || blockType == BlockTypeEnum.CrateStone || blockType == BlockTypeEnum.CrateIron || blockType == BlockTypeEnum.CrateCopper || blockType == BlockTypeEnum.CrateGold || blockType == BlockTypeEnum.CrateDiamond || blockType == BlockTypeEnum.CrateBloodstone)
			{
				return true;
			}
			return false;
		...
		{
			if (!IsUpperDoor(blockType) && !IsLowerDoor(blockType) && blockType != BlockTypeEnum.NormalLowerDoor)
			{
				return blockType == BlockTypeEnum.StrongLowerDoor;
			}
			return true;
		}
		...
		{
			if (blockType != BlockTypeEnum.EnemySpawnOff && blockType != BlockTypeEnum.EnemySpawnRareOff && blockType != BlockTypeEnum.AlienSpawnOff && blockType != BlockTypeEnum.HellSpawnOff)
			{
				return blockType == BlockTypeEnum.BossSpawnOff;
			}
			return true;
		}
		...
		{
			if (blockType != BlockTypeEnum.LootBlock)
			{
				return blockType == BlockTypeEnum.LuckyLootBlock;
			}
			return true;
		}
		...
		{
			if (blockType == BlockTypeEnum.NormalUpperDoorClosed || blockType == BlockTypeEnum.NormalUpperDoorOpen || blockType == BlockTypeEnum.StrongUpperDoorClosed || blockType == BlockTypeEnum.StrongUpperDoorOpen)
			{
				return true;
			}
			return false;
		...
		{
			if (blockType == BlockTypeEnum.SpawnPointBasic || blockType == BlockTypeEnum.SpawnPointBuilder || blockType == BlockTypeEnum.SpawnPointExplorer || blockType == BlockTypeEnum.SpawnPointCombat || blockType == BlockTypeEnum.TeleportStation || blockType == BlockTypeEnum.GlassIron || blockType == BlockTypeEnum.GlassStrong || blockType == BlockTypeEnum.GlassMystery || blockType == BlockTypeEnum.GlassBasic)
			{
				return true;
			}
			return false;
