...
{
	public class GrenadeLauncherGuidedInventoryItemClass : GrenadeLauncherBaseInventoryItemClass
	{
		...
		public GrenadeLauncherGuidedInventoryItemClass(InventoryItemIDs id, string name, string description, float damage, float durabilitydamage, InventoryItem.InventoryItemClass ammotype)
		...
		{
			return new GrenadeLauncherGuidedItem(this, stackCount);
		}
