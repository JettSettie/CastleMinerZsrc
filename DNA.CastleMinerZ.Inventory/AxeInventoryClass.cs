...
namespace DNA.CastleMinerZ.Inventory
{
	public class AxeInventoryClass : ModelInventoryItemClass
	{
		...
		public AxeInventoryClass(InventoryItemIDs id, ToolMaterialTypes material, Model model, string name, string description, float meleeDamage)
		...
		public override Entity CreateEntity(ItemUse use, bool attachedToLocalPlayer)
		{
			...
			case ItemUse.UI:
			{
				...
				Matrix localToParent = Matrix.Transform(Matrix.CreateScale(960f / castleMinerToolModel.GetLocalBoundingSphere().Radius), rotation);
				Vector3 vector2 = localToParent.Translation = new Vector3(-10f, -15f, 0f);
